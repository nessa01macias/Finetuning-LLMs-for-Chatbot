...
def main():
    ...
    combined_data_path = os.path.join(pdf_dir, 'sustainability_pdfs', 'results', 'final', 'all_data_combined.json')
    ...
    split_json_file(train_file_path, results_dir, 10)
...
def split_json_file(source_file_path, output_directory, number_of_splits):
    ...
    for i in range(number_of_splits):
        ...
        split_file_path = f"{output_directory}/train_data_split_{i+1}.json"
