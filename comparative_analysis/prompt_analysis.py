...
def main():
    ...
    models_and_tokenizers = {
        # "phi2_finetuned": (AutoModelForCausalLM.from_pretrained("nessa01macias/phi-2_sustainability-qa", trust_remote_code=False, torch_dtype=torch.float16),
        ...
        "phi2": (AutoModelForCausalLM.from_pretrained("microsoft/phi-2", trust_remote_code=False),
                 AutoTokenizer.from_pretrained("microsoft/phi-2", trust_remote_code=False)),
        "gemma_2b_finetuned": (AutoModelForCausalLM.from_pretrained("nessa01macias/gemma-2b_sustainability-qa", trust_remote_code=False, torch_dtype=torch.float16),
        ...
        "gemma_2b": (AutoModelForCausalLM.from_pretrained("google/gemma-2b", trust_remote_code=False),
                        AutoTokenizer.from_pretrained("google/gemma-2b", trust_remote_code=False)),
        "gemma_7b_finetuned": (AutoModelForCausalLM.from_pretrained("nessa01macias/gemma-7b_sustainability-qa", trust_remote_code=False, torch_dtype=torch.float16),
                               AutoTokenizer.from_pretrained("google/gemma-7b", trust_remote_code=False)),
        "gemma_7b": (AutoModelForCausalLM.from_pretrained("google/gemma-7b", trust_remote_code=False),
                        AutoTokenizer.from_pretrained("google/gemma-7b", trust_remote_code=False)),
        # "llama3_8b_finetuned": (AutoModelForCausalLM.from_pretrained("nessa01macias/llama-3-8b_sustainability-qa", trust_remote_code=False, torch_dtype=torch.float16),
        #                        AutoTokenizer.from_pretrained("meta-llama/Meta-Llama-3-8B", trust_remote_code=False)),
        "llama3_8b": (AutoModelForCausalLM.from_pretrained("meta-llama/Meta-Llama-3-8B", trust_remote_code=False),
                        AutoTokenizer.from_pretrained("meta-llama/Meta-Llama-3-8B", trust_remote_code=False))
    }
